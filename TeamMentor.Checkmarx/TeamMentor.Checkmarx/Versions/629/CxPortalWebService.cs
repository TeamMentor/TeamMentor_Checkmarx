...
namespace Checkmarx629
{
    ...
    public class CxPortalWebService
    {
        ...
        [WebMethod()]
        public CxWSBasicRepsonse SaveSubsetResults(string sessionId, long projectId, long ScanId, long[] pathIds,
            string comments)
        {
        ...
        [WebMethod()]
        public CxWSBasicRepsonse ImportQueries(string sessionId,
            [System.Xml.Serialization.XmlElementAttribute(DataType = "base64Binary")] byte[] importedFile)
        {
        ...
        [WebMethod()]
        public CxWSResponseTransportedQueries GetExistingQueries(string sessionId,
            [System.Xml.Serialization.XmlElementAttribute(DataType = "base64Binary")] byte[] importedFile)
        {
        ...
        [WebMethod()]
        public CxWSResponseExistsingTransportedPresetQueries GetExistingPresetQueries(string sessionId,
            [System.Xml.Serialization.XmlElementAttribute(DataType = "base64Binary")] byte[] importedFile)
        {
            CxWSResponseExistsingTransportedPresetQueries result = WebServiceProxy.GetExistingPresetQueries(sessionId,
                importedFile);
            return result;
        }

        [WebMethod()]
        public CxWSBasicRepsonse ImportPreset(string sessionId,
            [System.Xml.Serialization.XmlElementAttribute(DataType = "base64Binary")] byte[] importedFile)
        {
        ...
        [WebMethod()]
        public CxWSResponseSourceID UploadProjectWithDefaultSettings(string sessionId,
            ProjectBasicSettings projectSettings, LocalCodeContainer localCodeContainer)
        {
            CxWSResponseSourceID result = WebServiceProxy.UploadProjectWithDefaultSettings(sessionId, projectSettings,
                localCodeContainer);
            return result;
        }
        ...
        public CxQueryCollectionResponse GetQueryCollectionForLanguage(string sessionId, int projectType, long projectId)
        {
            ...
            CxQueryCollectionResponse result = WebServiceProxy.GetQueryCollectionForLanguage(sessionId, projectType,
                projectId);
        ...
        [WebMethod()]
        public CxWSResponseBasicScanData AddScanResultsToProject(string sessionId, long projectId, string sourceId,
            AuditResultsCollection resultsCollection, string comment)
        {
            CxWSResponseBasicScanData result = WebServiceProxy.AddScanResultsToProject(sessionId, projectId, sourceId,
                resultsCollection, comment);
            return result;
        }
        ...
        [WebMethod()]
        public CxWSResponseFileSystemLayer GetSharedFileSystemLayer(string SessionID, string Path,
            Credentials UserCredentials)
        {
            CxWSResponseFileSystemLayer result = WebServiceProxy.GetSharedFileSystemLayer(SessionID, Path,
                UserCredentials);
            return result;
        }

        [WebMethod()]
        public CxWSResponseFileSystemLayer GetRepositoryFileSystemLayer(string SessionID, string Path,
            SourceControlSettings SourceControlSettings)
        {
            CxWSResponseFileSystemLayer result = WebServiceProxy.GetRepositoryFileSystemLayer(SessionID, Path,
        ...
        [WebMethod()]
        public CxWSResponseRunID CreateAndRunProject(string SessionID, ProjectSettings ProjectSettings,
            LocalCodeContainer LocalCodeContainer, bool visibleToOtherUsers)
        {
            CxWSResponseRunID result = WebServiceProxy.CreateAndRunProject(SessionID, ProjectSettings,
                LocalCodeContainer, visibleToOtherUsers);
            return result;
        }

        [WebMethod()]
        public CxWSResponseRunID RunScanAndAddToProject(string sessionId, ProjectSettings projectSettings,
            LocalCodeContainer localCodeContainer, bool visibleToUtherUsers)
        {
            CxWSResponseRunID result = WebServiceProxy.RunScanAndAddToProject(sessionId, projectSettings,
                localCodeContainer, visibleToUtherUsers);
            return result;
        }
        ...
        [WebMethod()]
        public CxWSBasicRepsonse UpdateProjectConfiguration(string sessionID, long projectID,
            ProjectConfiguration projectConfiguration)
        {
            CxWSBasicRepsonse result = WebServiceProxy.UpdateProjectConfiguration(sessionID, projectID,
                projectConfiguration);
            return result;
        }

        [WebMethod()]
        public CxWSBasicRepsonse UpdateProjectIncrementalConfiguration(string sessionID, long projectID,
            ProjectConfiguration projectConfiguration)
        {
            CxWSBasicRepsonse result = WebServiceProxy.UpdateProjectIncrementalConfiguration(sessionID, projectID,
                projectConfiguration);
            return result;
        }
        ...
        [WebMethod()]
        public CxWSBasicRepsonse SetFalsePositiveFlag(string sessionID, long ResultId, long PathId, long projectId,
            bool falsePositiveFlag)
        {
            CxWSBasicRepsonse result = WebServiceProxy.SetFalsePositiveFlag(sessionID, ResultId, PathId, projectId,
                falsePositiveFlag);
            return result;
        }

        [WebMethod()]
        public CxWSBasicRepsonse UpdateResultComment(string sessionID, long ResultId, long PathId, long projectId,
            string comment)
        {
            CxWSBasicRepsonse result = WebServiceProxy.UpdateResultComment(sessionID, ResultId, PathId, projectId,
                comment);
            return result;
        }

        [WebMethod()]
        public CxWSBasicRepsonse UpdateResultState(string sessionID, long scanId, long PathId, long projectId,
            string Remarks, int ResultLabelType, string data)
        {
            CxWSBasicRepsonse result = WebServiceProxy.UpdateResultState(sessionID, scanId, PathId, projectId, Remarks,
                ResultLabelType, data);
            return result;
        }
        ...
        {
            CxWSResponseScanCompareSummary result = WebServiceProxy.GetScanCompareSummary(sessionId, oldScanId,
                newScanId);
            return result;
        }
        ...
        {
            CxWSResponceScanCompareResults result = WebServiceProxy.GetCompareScanResults(sessionId, oldScanId,
                newScanId);
            return result;
        }
        ...
        [WebMethod()]
        public CxWSBasicRepsonse UpdateUserGroups(string sessionID, long userID, Group[] unsubscribedGroups,
            Group[] subscribedGroups, Role role)
        {
            CxWSBasicRepsonse result = WebServiceProxy.UpdateUserGroups(sessionID, userID, unsubscribedGroups,
                subscribedGroups, role);
            return result;
        }
        ...
        [WebMethod()]
        public CxWSBasicRepsonse CreateNewCompany(string sessionID, string ParentSP, string newTCompanyName,
            int companyManagers, int scanners, int reviewers, bool allowActions)
        {
            CxWSBasicRepsonse result = WebServiceProxy.CreateNewCompany(sessionID, ParentSP, newTCompanyName,
                companyManagers, scanners, reviewers, allowActions);
            return result;
        }

        [WebMethod()]
        public CxWSBasicRepsonse CreateNewServiceProvider(string sessionID, string newSpName, int spManagersint,
            int companyManagers, int scanners, int reviewers)
        {
            CxWSBasicRepsonse result = WebServiceProxy.CreateNewServiceProvider(sessionID, newSpName, spManagersint,
                companyManagers, scanners, reviewers);
            return result;
        }
        ...
        [WebMethod()]
        public CxWSBasicRepsonse UpdateCompanyProperties(string sessionID, string companyID, string companyName,
            int maxReviewers, int maxScanners, int maxManagers)
        {
            CxWSBasicRepsonse result = WebServiceProxy.UpdateCompanyProperties(sessionID, companyID, companyName,
                maxReviewers, maxScanners, maxManagers);
            return result;
        }
